...
class Settings(BaseModel):
    ...
    BB_AUDIO_SCORING_DUPLICATION_SIMILARITY_THRESHOLD: float
    BB_AUDIO_SCORING_DUPLICATION_GAMMA: float
    BB_AUDIO_SCORING_DUPLICATION_MIN_SCORE_FOR_PRESSURE: float
    BB_AUDIO_SCORING_DUPLICATION_SCORE_EPSILON: float
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        BB_AUDIO_SCORING_DUPLICATION_SIMILARITY_THRESHOLD=float(
            getenv("BB_AUDIO_SCORING_DUPLICATION_SIMILARITY_THRESHOLD", "0.88")
        ),
        BB_AUDIO_SCORING_DUPLICATION_GAMMA=float(
            getenv("BB_AUDIO_SCORING_DUPLICATION_GAMMA", "0.5")
        ),
        BB_AUDIO_SCORING_DUPLICATION_MIN_SCORE_FOR_PRESSURE=float(
            getenv("BB_AUDIO_SCORING_DUPLICATION_MIN_SCORE_FOR_PRESSURE", "0.0")
        ),
        BB_AUDIO_SCORING_DUPLICATION_SCORE_EPSILON=float(
            getenv("BB_AUDIO_SCORING_DUPLICATION_SCORE_EPSILON", "0.02")
        ),
